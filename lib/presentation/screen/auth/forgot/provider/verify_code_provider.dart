...
import 'package:project_crew/presentation/screen/auth/forgot/provider/verify_code_state.dart';
...
class VerifyCode extends _$VerifyCode {
  ...
  Future<void> load({bool reload = false, bool forSignup = false}) async {
    ...
    state = state.copyWith(modal: const ModalEntity(showLoading: false), verified: false);
  }
