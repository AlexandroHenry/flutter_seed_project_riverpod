...
import 'change_password_with_code_screen.dart';
import '../../forgot/provider/verify_code_provider.dart';
import '../../forgot/provider/verify_code_state.dart';
      ...
      if ((prev?.verified != state.verified) && state.verified) {
        if (widget.returnCode) {
          ...
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (_) => ChangePasswordWithCodeScreen(
                email: widget.email,
