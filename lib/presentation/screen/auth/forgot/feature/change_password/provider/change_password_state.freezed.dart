...
mixin _$ChangePasswordState {
 ...
 ModalEntity get modal; bool get completed;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChangePasswordState&&(identical(other.modal, modal) || other.modal == modal)&&(identical(other.completed, completed) || other.completed == completed));
}


@override
int get hashCode => Object.hash(runtimeType,modal,completed);

@override
String toString() {
  return 'ChangePasswordState(modal: $modal, completed: $completed)';
}
...
@useResult
$Res call({
 ModalEntity modal, bool completed
});
...
/// Create a copy of ChangePasswordState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? modal = null,Object? completed = null,}) {
  return _then(_self.copyWith(
modal: null == modal ? _self.modal : modal // ignore: cast_nullable_to_non_nullable
as ModalEntity,completed: null == completed ? _self.completed : completed // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
/// Create a copy of ChangePasswordState
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ModalEntity modal,  bool completed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChangePasswordState() when $default != null:
return $default(_that.modal,_that.completed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ModalEntity modal,  bool completed)  $default,) {final _that = this;
switch (_that) {
case _ChangePasswordState():
return $default(_that.modal,_that.completed);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ModalEntity modal,  bool completed)?  $default,) {final _that = this;
switch (_that) {
case _ChangePasswordState() when $default != null:
return $default(_that.modal,_that.completed);case _:
  return null;
...
class _ChangePasswordState implements ChangePasswordState {
  const _ChangePasswordState({this.modal = const ModalEntity(), this.completed = false});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ChangePasswordState&&(identical(other.modal, modal) || other.modal == modal)&&(identical(other.completed, completed) || other.completed == completed));
}
...
/// Create a copy of ChangePasswordState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? modal = null,Object? completed = null,}) {
